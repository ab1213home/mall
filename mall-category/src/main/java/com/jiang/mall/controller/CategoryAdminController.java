...
public class CategoryAdminController {
     ...
     */
    @GetMapping("/getList")
    @Permission(value = PermissionType.ADMIN, permission = "category:list")
     ...
     */
    @PostMapping("/update")
    @Permission(value = PermissionType.ADMIN, permission = "category:update")
...
//}
     ...
     */
    @GetMapping("/delete")
    @Permission(value = PermissionType.ADMIN, permission = "category:delete")
    ...
    @Permission(value = PermissionType.SYSTEM, permission = "category")
