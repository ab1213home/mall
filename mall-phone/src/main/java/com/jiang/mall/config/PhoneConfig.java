...
import com.jiang.mall.domain.enums.PhoneConfigItems;
...
public class PhoneConfig {
    ...
    public void loadProperties() {
        ...
        if (configFile.exists()) {
            try (InputStream input = new FileInputStream(configFile)) {
                ...
                for (PhoneConfigItems item : PhoneConfigItems.values()){
    ...
    public String getEmailHost() {
        return properties.getProperty(PhoneConfigItems.EMAIL_HOST.getKey(), PhoneConfigItems.EMAIL_HOST.getDefaultValue());
    }
    ...
    public @NotNull Boolean isEmailAuth() {
        return Boolean.parseBoolean(properties.getProperty(PhoneConfigItems.EMAIL_AUTH.getKey(), PhoneConfigItems.EMAIL_AUTH.getDefaultValue()));
    }
    ...
    public @NotNull Boolean isEmailTls() {
        return Boolean.parseBoolean(properties.getProperty(PhoneConfigItems.EMAIL_TLS.getKey(), PhoneConfigItems.EMAIL_TLS.getDefaultValue()));
    }
    ...
    public String getEmailPort() {
        return properties.getProperty(PhoneConfigItems.EMAIL_PORT.getKey(), PhoneConfigItems.EMAIL_PORT.getDefaultValue());
    }
    ...
    public String getEmailUsername() {
        return properties.getProperty(PhoneConfigItems.EMAIL_USERNAME.getKey(), PhoneConfigItems.EMAIL_USERNAME.getDefaultValue());
    }
    ...
    public String getEmailSenderEnd() {
        return properties.getProperty(PhoneConfigItems.EMAIL_SENDER_END.getKey(), PhoneConfigItems.EMAIL_SENDER_END.getDefaultValue());
    }
    ...
    public String getEmailPassword() {
        return properties.getProperty(PhoneConfigItems.EMAIL_PASSWORD.getKey(), PhoneConfigItems.EMAIL_PASSWORD.getDefaultValue());
    }
    ...
    public int getEmailExpirationTime() {
        return Integer.parseInt(properties.getProperty(PhoneConfigItems.EMAIL_EXPIRATION_TIME.getKey(), PhoneConfigItems.EMAIL_EXPIRATION_TIME.getDefaultValue()));
    }
    ...
    public int getEmailMaxRequestNum() {
        return Integer.parseInt(properties.getProperty(PhoneConfigItems.EMAIL_MAX_REQUEST_NUM.getKey(), PhoneConfigItems.EMAIL_MAX_REQUEST_NUM.getDefaultValue()));
    }
    ...
    public int getEmailMinRequestNum() {
        return Integer.parseInt(properties.getProperty(PhoneConfigItems.EMAIL_MIN_REQUEST_NUM.getKey(), PhoneConfigItems.EMAIL_MIN_REQUEST_NUM.getDefaultValue()));
    }
    ...
    public double getEmailMaxFailRate() {
        return Double.parseDouble(properties.getProperty(PhoneConfigItems.EMAIL_MAX_FAIL_RATE.getKey(), PhoneConfigItems.EMAIL_MAX_FAIL_RATE.getDefaultValue()));
    }
    ...
    public boolean isSendEmailEnabled() {
        return Boolean.parseBoolean(properties.getProperty(PhoneConfigItems.ALLOW_SEND_EMAIL.getKey(), PhoneConfigItems.ALLOW_SEND_EMAIL.getDefaultValue()));
    }
...
//    }
    ...
    public void updateEmailHost(String host) {
        // 设置新的邮件服务主机地址到属性文件中
        properties.setProperty(PhoneConfigItems.EMAIL_HOST.getKey(), host);
    }
    ...
    public void updateEmailPort(String port) {
        // 设置新的邮件端口号到配置属性中
        properties.setProperty(PhoneConfigItems.EMAIL_PORT.getKey(), port);
    }
    ...
    public void updateEmailAuth(Boolean auth) {
        ...
        properties.setProperty(PhoneConfigItems.EMAIL_AUTH.getKey(), String.valueOf(auth));
    }
    ...
    public void updateEmailTls(Boolean tls) {
        // 更新邮件配置中的TLS设置
        properties.setProperty(PhoneConfigItems.EMAIL_TLS.getKey(), String.valueOf(tls));
    }
    ...
    public void updateEmailUsername(String username) {
        properties.setProperty(PhoneConfigItems.EMAIL_USERNAME.getKey(), username);
    }
    ...
    public void updateEmailSenderEnd(String senderEnd) {
        // 设置新的邮件发送者结束语到属性文件中
        properties.setProperty(PhoneConfigItems.EMAIL_SENDER_END.getKey(), senderEnd);
    }
    ...
    public void updateEmailPassword(String password) {
        // 设置新的邮件密码到属性文件中
        properties.setProperty(PhoneConfigItems.EMAIL_PASSWORD.getKey(), password);
    }
    ...
    public void updateEmailExpirationTime(int milliseconds) {
        // 设置邮件过期时间系统属性
        properties.setProperty(PhoneConfigItems.EMAIL_EXPIRATION_TIME.getKey(), String.valueOf(milliseconds));
    }
    ...
    public void updateEmailMaxRequestNum(int num) {
        // 设置新的邮件最大请求数量到属性文件中
        properties.setProperty(PhoneConfigItems.EMAIL_MAX_REQUEST_NUM.getKey(), String.valueOf(num));
    }
    ...
    public void updateEmailMinRequestNum(int num) {
        ...
        properties.setProperty(PhoneConfigItems.EMAIL_MIN_REQUEST_NUM.getKey(), String.valueOf(num));
    }
    ...
    public void updateEmailMaxFailRate(double rate) {
        ...
        properties.setProperty(PhoneConfigItems.EMAIL_MAX_FAIL_RATE.getKey(), String.valueOf(rate));
    }
    ...
    public void updateSendEmailEnabled(boolean enabled) {
        ...
        properties.setProperty(PhoneConfigItems.ALLOW_SEND_EMAIL.getKey(), String.valueOf(enabled));
    }
