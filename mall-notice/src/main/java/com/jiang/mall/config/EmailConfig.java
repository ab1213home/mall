...
public class EmailConfig {
    ...
    private void iniEmailConfig() {
        ...
        if (isEmailAuth()){
            String username = email.getProperty(EmailConfigItems.EMAIL_USERNAME.getKey(), EmailConfigItems.EMAIL_USERNAME.getDefaultValue());
            String password = email.getProperty(EmailConfigItems.EMAIL_PASSWORD.getKey(), EmailConfigItems.EMAIL_PASSWORD.getDefaultValue());
            // 创建会话对象，用于发送邮件
    ...
    public Properties getEmailProperties() {
		...
		// 设置邮件服务器主机名
	    email.put("mail.smtp.host", properties.getProperty(EmailConfigItems.EMAIL_HOST.getKey(), EmailConfigItems.EMAIL_HOST.getDefaultValue()));
	    // 设置邮件服务器端口号
		email.put("mail.smtp.port", properties.getProperty(EmailConfigItems.EMAIL_PORT.getKey(), EmailConfigItems.EMAIL_PORT.getDefaultValue()));
	    // 启用身份验证
		email.put("mail.smtp.auth", Boolean.parseBoolean(properties.getProperty(EmailConfigItems.EMAIL_AUTH.getKey(), EmailConfigItems.EMAIL_AUTH.getDefaultValue())));
	    // 启用 TLS
		email.put("mail.smtp.starttls.enable", Boolean.parseBoolean(properties.getProperty(EmailConfigItems.EMAIL_TLS.getKey(), EmailConfigItems.EMAIL_TLS.getDefaultValue())));
	    // 设置 SSL 端口
		email.put("mail.smtp.socketFactory.port", properties.getProperty(EmailConfigItems.EMAIL_PORT.getKey(), EmailConfigItems.EMAIL_PORT.getDefaultValue()));
